...
namespace MassTransit.Incremental.Contracts
{
    ...
    /// <summary>
    /// Message contract for the final consume that is sent back to the consumer via the transport,
    ...
    public interface Final<out TContext, out TMessage>
        ...
        where TContext : class
    {
        ...
        /// <summary>
        /// The final context provided by the consumer
        /// </summary>
