...
namespace MassTransit.Incremental
{
    ...
    public class NextIncrementalResult<TContext, TMessage> :
        ...
        where TMessage : class
    {
        ...
        public NextIncrementalResult(IncrementContext<TContext, TMessage> incrementContext, TContext context)
            : base(context)
        {
        ...
        public Task Send()
        {
            Increment<TContext, TMessage> increment = new Next(_incrementContext, this);
            ...
            Increment<TContext, TMessage>
        {
            ...
            public Next(IncrementContext<TContext, TMessage> incrementContext, IncrementalResult<TContext> context)
            {
                _incrementContext = incrementContext;
                _context = context;
            }
