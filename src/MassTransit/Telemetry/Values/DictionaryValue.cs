...
namespace MassTransit.Telemetry.Values
{
    ...
    /// </summary>
    public class DictionaryValue : TelemetryLogEventPropertyValue
    {
        /// <summary>
        ...
        public DictionaryValue(IEnumerable<KeyValuePair<ScalarValue, TelemetryLogEventPropertyValue>> elements)
        {
            if (elements == null)
        ...
        /// </summary>
        public IReadOnlyDictionary<ScalarValue, TelemetryLogEventPropertyValue> Elements { get; }
