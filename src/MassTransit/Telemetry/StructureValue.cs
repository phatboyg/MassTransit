...
namespace MassTransit.Telemetry
{
    ...
    /// </summary>
    public class StructureValue : TelemetryLogEventPropertyValue
    {
        readonly TelemetryLogEventProperty[] _properties;
        ...
        public StructureValue(IEnumerable<TelemetryLogEventProperty> properties, string typeTag = null)
        {
            if (properties == null)
        ...
        public IReadOnlyList<TelemetryLogEventProperty> Properties => _properties;
        ...
        static void Render(TextWriter output, TelemetryLogEventProperty property, IFormatProvider formatProvider = null)
        {
