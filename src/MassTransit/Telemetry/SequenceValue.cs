...
namespace MassTransit.Telemetry
{
    ...
    /// </summary>
    public class SequenceValue : TelemetryLogEventPropertyValue
    {
        readonly TelemetryLogEventPropertyValue[] _elements;
        ...
        public SequenceValue(IEnumerable<TelemetryLogEventPropertyValue> elements)
        {
            if (elements == null)
        ...
        /// </summary>
        public IReadOnlyList<TelemetryLogEventPropertyValue> Elements => _elements;
