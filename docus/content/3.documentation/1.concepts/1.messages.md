...
::list{type="success"}
  - Use records, define properties as `public` and specify `{ get; init; }` accessors. Create messages using the constructor/object initializer or a [message initializer](producers#initializers).
